...
const About = () => {
  ...
  return <section className="py-24" style={{ backgroundColor: '#af8419' }}>
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          duration: 0.8
            ...
            <img src={aboutImage} alt="Capela Mortuária do Cemitério São José - Estrutura" className="rounded-2xl shadow-2xl w-full h-[400px] md:h-[500px] object-cover" />
          </motion.div>
