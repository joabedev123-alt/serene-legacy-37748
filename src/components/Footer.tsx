      ...
      <div className="container mx-auto px-4 py-8 sm:py-10 md:py-12 lg:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8 md:mb-12">
          ...
          <div className="space-y-3 sm:space-y-4 text-center sm:text-left">
            <img src={logoDC} alt="Funerária D.C." className="h-16 sm:h-20 md:h-24 brightness-0 invert mx-auto sm:mx-0" />
          ...
          <div className="space-y-3 sm:space-y-4 text-center sm:text-left">
            ...
            <div className="space-y-2 sm:space-y-3">
              <a
                ...
                className="flex items-center gap-2 sm:gap-3 text-xs sm:text-sm text-primary-foreground/80 hover:text-primary-foreground transition-colors justify-center sm:justify-start"
              >
          ...
          {/* Address */}
          <div className="space-y-3 sm:space-y-4 text-center sm:text-left">
            <h3 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4">Nossas Unidades</h3>
            <div className="space-y-2 sm:space-y-3">
              <div className="flex items-start gap-2 sm:gap-3 text-xs sm:text-sm text-primary-foreground/80 justify-center sm:justify-start">
                <MapPin className="w-3.5 h-3.5 sm:w-4 sm:h-4 flex-shrink-0 mt-1" />
          ...
          <div className="space-y-3 sm:space-y-4 text-center sm:text-left">
            ...
            <div className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-primary-foreground/80">
