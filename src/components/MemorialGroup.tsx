...
const MemorialGroup = () => {
  return (
    <section id="grupo" className="py-24" style={{ backgroundColor: '#af8419' }}>
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-display font-bold text-foreground leading-tight px-4">
              Funerária D.C.
            </h2>
            <p className="text-xl md:text-2xl text-primary font-semibold px-4">
